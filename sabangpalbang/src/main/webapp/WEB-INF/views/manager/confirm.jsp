...
<div class="container-fluid" style="padding-left:0!important;">
	...
	<div class="col-sm-9 page">
		<h3 style="padding-top:30px; margin-bottom:20px;">승인 요청</h3>
		  					...
		  					<tbody id="list">
								...
								<tr>
									...
									<c:choose>
					 					...
					 					<button class="btn btn-outline-primary" id="confirm_ok" name="confirmcheck" value="1" >승인</button>
					 					<button class="btn btn-outline-danger" id="confirm_no" name="confirmcheck" value="2" >반려</button>
										</c:when>
										<c:when test="${property.confirm_check==1}">
									 	<button class="btn btn-outline-warning" id="ok_cancel" name="confirmcheck" value="0" >승인 취소</button>
										</c:when>
										<c:when test="${property.confirm_check==2}">
									 	<button class="btn btn-outline-warning" id="no_cancel" name="confirmcheck" value="0">반려 취소</button>
										</c:when>
									</c:choose>
									</form>
