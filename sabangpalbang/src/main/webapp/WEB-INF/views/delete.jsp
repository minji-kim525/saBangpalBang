...
<div class="container-fluid" style="padding-left:0!important;">
	...
	<div class="col-sm-9 page">
		<h3 style="padding-top:30px; margin-bottom:20px;">회원 탈퇴</h3>
	

	<form id="withdrawalForm" action="/delete" method="post">
        <button class="btn btn-danger" onclick="confirmWithdrawal()" type="button">탈퇴하기</button>
    </form>
...
<script>
		function confirmWithdrawal() {
			if (confirm("정말로 탈퇴하시겠습니까?")) {
				// 탈퇴 처리를 위한 코드를 여기에 작성하세요.
				document.forms["withdrawalForm"].submit();
			}
		}
</script>